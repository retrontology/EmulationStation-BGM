    ...
    def verify_config(self, cfg_delta):
        ...
        for option in cfg_delta.keys():
            ...
            try:
                ...
                logging.warning("Unexpected breaking option provided: {}".format(e))
            if not check_pass:
...
class Application:
    ...
    def init_parent(self):
        ...
        if self.config['start_song']:
            ...
            self.mp.play(song_name=self.config['start_song'])
    ...
    def main_loop(self):
        ...
        while True:
            ...
            if not self.mute:
                ...
                self.play_on_idle() ##FIXIT## Main loop is finishing before the start_song begins playing. ##
    ...
    def process_args(self, args):
        ...
        if 'set' in args['player_cmd']:
            ...
            if self.mp:
                self.mp.update_config(config=args['values'])
    ...
    def process_monitor(self):
        ...
        if self.proc_countdown > 0 and self.proc_mute:
            ...
            logging.debug("Current countdown: {}".format(self.proc_countdown))
